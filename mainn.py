...
face_classifier = cv2.CascadeClassifier(r'D:\semester4\computer_vision\project\haarcascade_frontalface_default.xml')
classifier = load_model(r'D:\semester4\computer_vision\project\Emotion_little_vgg.h5')
